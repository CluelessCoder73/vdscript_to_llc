...
# ----------------------------------------------------------------------
# Script: vdscript_to_llc_v1.2.0.py
# Description:
...
if __name__ == "__main__":
    ...
    extra_frames_end = 6  # Number of frames to add to the end of each cut
    add_segment_number = True  # Set to True to add segment numbers in the "name" field
